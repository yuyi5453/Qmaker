						...
						<s:iterator value="QuestionnaireContent" id="id" status="st">
							<div class="row">
								<div class="col-md-12">
											...
											<table>
												<tbody>
													<s:iterator value="#id.optionList" id="subId"
														status="subSt">
														<tr>
															<s:if test="#subId.isUserAnswer=='yes'">
									...
									<s:else>
										<div class="essay">
											<textarea name="Option4Question[<s:property value="#id.questionNo"/>]" id="" cols="60" rows="3" readonly><s:property value="#id.userAnswer"/></textarea>
										</div>
									</s:else>
								</div>
							</div>
