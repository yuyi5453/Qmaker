        ...
        <div class="container-fluid" style="width: 100%; height: 100%;background-color: #c3e1f598">
            ...
            <div class="row">
                ...
                <div class="col-md-8" style=" height: 100%;background-image: url(pic/RegisterBackground.jpg);background-repeat: no-repeat;background-size: cover;">
                    <div class="card" style="margin-left: 30%;margin-right: 30%;margin-top: 3%;height: 880px;box-shadow: 0px 0px 10px 5px #c3e1f5b7;overflow: auto">
                        <div class="card-body">
                            <div class="row">
                                
                                <div class="col-md-9 mx-auto">
                                    <h2 style="text-align: center;margin-top: 20%;margin-bottom: 20%;">用户查询</h2>
