...
public class QuestionDetailId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof QuestionDetailId) ) return false;
		 QuestionDetailId castOther = ( QuestionDetailId ) other; 
         
		 return ( (this.getQuestionnaireId()==castOther.getQuestionnaireId()) || ( this.getQuestionnaireId()!=null && castOther.getQuestionnaireId()!=null && this.getQuestionnaireId().equals(castOther.getQuestionnaireId()) ) )
 && ( (this.getQuestionNo()==castOther.getQuestionNo()) || ( this.getQuestionNo()!=null && castOther.getQuestionNo()!=null && this.getQuestionNo().equals(castOther.getQuestionNo()) ) );
   }
