...
<script src="EditPaper.js" charset="utf-8"></script>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row question-content-bar form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="for-edit">
                                                                <input type="text" name="Question[<s:property value="#id.questionNo"/>]" id="" value="<s:property value="#id.questionContent" />" class="form-control" >
                                                            </div>
                                                            ...
                                                            <div class="for-preview">
                                                            	<div class="row">
                                                            		...
                                                            		<div class="col-md-10"><p style="margin-bottom: 0px"><s:property value="#id.score"/></p></div>
                                                            	</div>
                                                            </div>
                                                            <div class="for-edit">
                                                            ...
                                                            <table class="option-table" style="word-break: break-all;">
                                                                <tbody>
                                                                    ...
                                                                    <tr class="for-edit" >
                                                                        <td><p class="iconfont icon-option"></p></td>
                                                                        <td><input type="text" name="option[<s:property value="#subId.questionNo"/>]" id="" class="form-control option" value="<s:property value="#subId.optionContent" />"></td>
                                                                        <s:if test="#subId.isStandardAnswer == 'yes'">
                                                                        	<td><input type='radio' name='standardAnswer[<s:property value="#subId.questionNo"/>]' id='' class='answer' value='<s:property value="#subId.optionNo"/>' checked></td>
                                                                        </s:if>
                                                                        <s:else>
                                                                        	<td><input type='radio' name='standardAnswer[<s:property value="#subId.questionNo"/>]' id='' class='answer' value='<s:property value="#subId.optionNo"/>'></td>
                                                                        </s:else>
                                                            ...
                                                            <table class="option-table" style="word-break: break-all;">
                                                                <tbody>
                                                                    ...
                                                                    <tr class="for-edit" >
                                                                        ...
                                                                        <td><input type="text" name="option[<s:property value="#subId.questionNo"/>]" id="" class="form-control option" value="<s:property value="#subId.optionContent" />"></td>
                                                                    	<s:if test="#subId.isStandardAnswer == 'yes'">
                                                                        	<td><input type='checkbox' name='standardAnswer[<s:property value="#subId.questionNo"/>]' id='' class='answer' value='<s:property value="#subId.optionNo"/>' checked></td>
                                                                        </s:if>
                                                                        <s:else>
                                                                        	<td><input type='checkbox' name='standardAnswer[<s:property value="#subId.questionNo"/>]' id='' class='answer' value='<s:property value="#subId.optionNo"/>'></td>
                                                                        </s:else>
                                                                    </tr>
                                                                    </s:iterator>
                                                                </tbody>
